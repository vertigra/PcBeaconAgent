...
{
    private readonly IBeaconClient mScanner;
    private readonly ISignalService mSignalService;
    private readonly ILogger<DiscoveryViewModel> mLogger;
    ...
    private void OnBeaconFound(DiscoveredBeacon beacon)
    {
        ...
        {
            if (mDeviceStore.ManagedDevices.Any(d => d.Device.IpAddress == beacon.IpAddress)) return;
